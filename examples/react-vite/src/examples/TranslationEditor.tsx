// Aliased: this file's own export is the example page of the same name.
import { TranslationEditor as CourierTranslationEditor } from "@trycourier/react-designer";
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <h3 style={{ margin: "0 0 12px", fontSize: "14px", fontWeight: 600 }}>Original (en)</h3>
          <CourierTranslationEditor
            value={enContent}
