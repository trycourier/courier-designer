      ...
      elements: [
        ...
        // Text node with content only, no elements, no markdown (plain content format)
        {
          ...
          locales: {
            fr: {
              content:
                "Merci d'avoir choisi notre service. Nous espérons que vous apprécierez votre expérience.",
            },
            es: {
              content:
                "Gracias por elegir nuestro servicio. Esperamos que disfrute su experiencia.",
            },
            ja: {
              content:
                "当サービスをお選びいただきありがとうございます。素晴らしい体験となることを願っております。",
            },
            "pt-BR": {
              content:
                "Obrigado por escolher nosso serviço. Esperamos que aproveite sua experiência.",
            },
          },
        },
        ...
        // Text with elements + mixed locales (some languages use content, others use elements)
        {
          ...
          locales: {
            fr: {
              content:
                "Besoin d'aide ? [Contacter le support](https://support.example.com/fr) ou visitez notre [FAQ](https://faq.example.com/fr).",
            },
            es: {
              elements: [
                { type: "string", content: "¿Necesita ayuda? " },
                {
                  ...
                  href: "https://support.example.com/es",
                },
                { type: "string", content: " o visite nuestras " },
                {
                  type: "link",
                  content: "Preguntas frecuentes",
                  href: "https://faq.example.com/es",
                },
                { type: "string", content: "." },
              ],
            },
            ...
            "pt-BR": {
              elements: [
                ...
                {
                  type: "link",
                  content: "Fale com o suporte",
                  href: "https://support.example.com/pt-br",
                },
        ...
        // Action (button) with locales
        {
          ...
          locales: {
            fr: {
              content: "Voir votre commande",
              href: "https://example.fr/commandes/{{order.id}}",
            },
            es: { content: "Ver su pedido", href: "https://example.es/pedidos/{{order.id}}" },
            ja: { content: "注文を確認する", href: "https://example.jp/orders/{{order.id}}" },
            "pt-BR": {
              content: "Ver seu pedido",
              href: "https://example.com.br/pedidos/{{order.id}}",
            },
          },
        },
        // HTML node with locales
        {
          type: "html",
          content:
            '<table width="100%"><tr><td style="text-align:center;padding:20px;background:#f5f5f5;"><small>You\'re receiving this because you signed up at example.com</small></td></tr></table>',
          locales: {
            fr: {
              content:
                '<table width="100%"><tr><td style="text-align:center;padding:20px;background:#f5f5f5;"><small>Vous recevez ceci car vous êtes inscrit sur example.fr</small></td></tr></table>',
            },
            es: {
              content:
                '<table width="100%"><tr><td style="text-align:center;padding:20px;background:#f5f5f5;"><small>Recibe esto porque se registró en example.es</small></td></tr></table>',
            },
            ja: {
              content:
                '<table width="100%"><tr><td style="text-align:center;padding:20px;background:#f5f5f5;"><small>example.jpに登録されているため、このメールを受信しています</small></td></tr></table>',
            },
            "pt-BR": {
              content:
                '<table width="100%"><tr><td style="text-align:center;padding:20px;background:#f5f5f5;"><small>Você recebeu isto porque se cadastrou em example.com.br</small></td></tr></table>',
            },
          },
        },
      ],
      ...
      elements: [
        ...
        },
        {
          ...
          locales: {
            ...
            "pt-BR": {
              content: "Rastrear envio",
              href: "https://example.com.br/rastreio/{{order.id}}",
            },
          },
        },
      ],
