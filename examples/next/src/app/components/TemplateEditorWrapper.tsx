...
const CustomHooksApp = () => {
  ...
  useEffect(() => {
    // IMPORTANT: Wrap the transformer function to prevent the store from treating it as an updater function
    ...
    // Set the transformer by wrapping it to avoid the store's updater-function behavior
