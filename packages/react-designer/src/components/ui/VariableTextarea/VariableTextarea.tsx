 ...
 */
const VariableChipIcon: React.FC<{ color?: string }> = ({ color = "#B45309" }) => (
  <svg
    width="14"
    height="14"
    viewBox="0 0 20 14"
...
/**
 * Standalone variable view component for VariableTextarea
 * Does not depend on external jotai stores
 */
const SimpleVariableView: React.FC<NodeViewProps> = ({ node }) => {
  return (
...
/**
 * Custom VariableNode for VariableTextarea that uses SimpleVariableView
 */
const SimpleVariableNode = Node.create({
  name: "variable",
  group: "inline",
  inline: true,
  selectable: false,
