...
import { HeadingBlock } from "../../../ui/Blocks/HeadingBlock";
import { ImageBlock } from "../../../ui/Blocks/ImageBlock";
import { SpacerBlock } from "../../../ui/Blocks/SpacerBlock";
...
export const TemplateEditor = forwardRef<HTMLDivElement, EditorProps>(
  ({ editor, handleEditorClick, isLoading, isVisible, isAutoSave }, ref) => {
