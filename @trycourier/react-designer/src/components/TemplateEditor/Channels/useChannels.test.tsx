...
let mockIsTemplatePending = false;
...
vi.mock("@/lib/store", async () => {
  ...
  return {
    ...
    useAtomValue: vi.fn((atom) => {
      ...
      if (atomStr.includes("isTemplatePending")) {
        return mockIsTemplatePending;
      }
      return null;
    }),
...
vi.mock("@/components/Providers/store", async () => {
  ...
  return {
    ...
    isTemplatePendingAtom: "isTemplatePendingAtom",
  };
});
...
const setMockState = (state: {
  ...
  if (state.isTemplatePending !== undefined) mockIsTemplatePending = state.isTemplatePending;
};

const resetMockState = () => {
  mockChannel = "email";
  mockTemplateEditorContent = null;
  mockIsTemplatePending = false;
};
...
describe("useChannels", () => {
  ...
  describe("initialization and enabled channels", () => {
    ...
    it("should not update while the template is still pending", () => {
      setMockState({
        templateContent: null,
        channel: "email",
